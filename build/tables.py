...
from src.gui_library import Grid
...
class HutsGrid(AbstractGrid, Grid):
    ...
    def _get_value(self, row, col):
        ...
        if key == 'height':
            ...
            try:
                ...
                view_errors.append({'type': type(e), 'message': str(e)})
...
class SelectedDetailedGrid(AbstractGrid, Grid):
...
class DetailedGrid(AbstractGrid, Grid):
...
class DeveloperGrid(AbstractGrid, Grid):
