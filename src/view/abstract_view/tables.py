...
class AbstractHutsGrid(AbstractGrid):
...
class AbstractSelectedDetailedGrid(AbstractGrid):
...
class AbstractDetailedGrid(AbstractGrid):
...
class AbstractDeveloperGrid(AbstractGrid):
